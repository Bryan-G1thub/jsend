  ...
  return (
    <div className="min-h-screen bg-black relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        <div className="absolute top-20 left-20 w-80 h-80 bg-gradient-to-r from-blue-400/30 via-blue-500/30 via-cyan-400/30 via-sky-400/30 to-indigo-400/30 rounded-full blur-3xl animate-pulse"></div>
        <div className="absolute bottom-20 right-20 w-96 h-96 bg-gradient-to-r from-indigo-400/30 via-blue-500/30 via-cyan-400/30 via-sky-300/30 to-blue-300/30 rounded-full blur-3xl animate-pulse"></div>
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-72 h-72 bg-gradient-to-r from-sky-400/30 via-blue-500/30 via-cyan-400/30 via-indigo-400/30 to-blue-400/30 rounded-full blur-3xl animate-pulse"></div>
        <div className="absolute top-1/4 right-1/4 w-64 h-64 bg-gradient-to-r from-cyan-400/30 via-blue-400/30 via-sky-400/30 via-indigo-400/30 to-blue-500/30 rounded-full blur-3xl animate-pulse"></div>
      </div>
        ...
        <div className="w-full max-w-4xl">
          ...
          <div className="text-center mb-20">
            <div className="inline-block mb-8">
              <div className="w-24 h-24 bg-gradient-to-r from-blue-400 via-blue-500 via-cyan-400 via-sky-400 to-indigo-500 rounded-2xl mx-auto mb-6 flex items-center justify-center shadow-2xl animate-pulse">
                <svg className="w-12 h-12 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 12a9 9 0 01-9 9m9-9a9 9 0 00-9-9m9 9H3m9 9v-9m0-9v9" />
                </svg>
              </div>
            </div>
            <h1 className="text-8xl font-bold bg-gradient-to-r from-blue-400 via-blue-500 via-cyan-400 via-sky-400 via-indigo-500 to-blue-600 bg-clip-text text-transparent mb-8 leading-tight">
              Domain Checker
          </h1>
            ...
            <input
              ...
              placeholder="example.com"
                      ...
                      className="w-full px-8 py-6 text-2xl bg-gray-900/50 border-2 border-gray-700 rounded-2xl 
                        ...
                        focus:ring-blue-500/50 focus:border-blue-400 transition-all duration-300
                        backdrop-blur-sm shadow-xl hover:shadow-2xl"
                    />
                    <div className="absolute inset-0 rounded-2xl bg-gradient-to-r from-blue-400/10 via-blue-500/10 via-cyan-400/10 via-sky-400/10 via-indigo-500/10 to-blue-600/10 opacity-0 hover:opacity-100 transition-opacity duration-300 pointer-events-none"></div>
                  </div>
                </div>
                ...
                <button 
                  ...
                  className="w-full py-6 px-10 bg-gradient-to-r from-blue-500 via-blue-600 via-cyan-500 via-sky-500 via-indigo-500 to-blue-700 
                  ...
                  <div className="absolute inset-0 bg-gradient-to-r from-blue-400 via-blue-500 via-cyan-400 via-sky-400 via-indigo-500 to-blue-600 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                </button>
              </div>
            </div>
          </div>
